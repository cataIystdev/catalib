...
На устройстве он доступен прямым импортом — со страховкой и за
адаптером:
...
Поверхность не задокументирована: проверяйте наличие атрибутов перед
вызовом, а офлайн-тесты держите на своём адаптере, не на самом `intents`.
